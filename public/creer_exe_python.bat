...
python -m PyInstaller --onefile --noconsole --clean --name "Discord_3-4L_Checker" discord_checker.py
if %errorlevel% neq 0 (
    color 0c
    echo.
...
echo   Dossier : dist\
echo   Fichier : Discord_3-4L_Checker.exe
echo.
echo   Ce fichier est 100%% autonome : double-cliquez dessus et l'application
echo   se lance directement avec sa belle interface sombre Discord !
echo ==============================================================================
echo.
pause
explorer dist
